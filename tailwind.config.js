    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { 
            boxShadow: '0 0 10px theme(colors.primary.500), 0 0 20px theme(colors.primary.500), 0 0 30px theme(colors.primary.500)',
      ...
      boxShadow: {
        ...
        'inner-glow': 'inset 0 2px 4px 0 rgba(99, 102, 241, 0.2)',
